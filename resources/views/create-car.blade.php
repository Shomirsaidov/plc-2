...
<div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow-md">
    ...
    <form action="{{ route('cars.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="vin" name="vin" class="w-full p-2 border rounded outline-blue-500" required>
        </div>

        <div class="mb-4">
            <label for="lot" class="block text-gray-700 font-medium mb-2">Номер лота</label>
            <input type="text" id="lot" name="lot" class="w-full p-2 border rounded outline-blue-500" required>
        </div>
