...
<head>
    ...
    <title>Регистрация нового админа</title>
...
<div class="w-full flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white shadow-md rounded-lg">
        <div class="flex justify-center">
            <img src="/assets/brand/logo.png" width="200" class="mb-8" alt="">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700">{{ __('ФИО') }}</label>
